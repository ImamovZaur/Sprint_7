...
class TestCreateCourier:
    ...
    def test_create_courier_account_created(self, create_delete_courier):
        response = create_delete_courier
    ...
    def test_create_duplicate_courier(self, delete_courier):
        ...
        assert (second_response.status_code == 409 and second_response.json().get('message') == TestData.MESSAGE_CONFLICT)
        courier_delete = delete_courier(courier_payload)
